...
//                                                                    
//   Memory Name:sadrls0s4LOW2p128x32m1b2w0c0p0d0t0s2z0rw00           
...
module sadrls0s4LOW2p128x32m1b2w0c0p0d0t0s2z0rw00 ( QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, RMEA, RMA, ADRB, MEB, CLKB, TEST1B, RMEB, RMB);
...
parameter words = 128, bits = 32, addrbits = 7, timingmode = 1, rmbits=4;
...
genvar nk;
generate for (nk=0; nk<32; nk=nk+1)
begin : ENDA_blk
        ...
        begin
          ...
          begin
            ...
            begin
             ...
             $display("      time=%t; instance=%m (sadrls0s4LOW2p128x32m1b2w0c0p0d0t0s2z0rw00_core)",$realtime);
            end // if (RMA >= 4'b1000
          end
          else
          begin
...
begin
  ...
  begin
    ...
    begin
      if( (MES_CNTRL=="ON" || MES_CNTRL=="WARN") && $realtime != 0 && mes_all_valid == 1'b1)
      begin
       $display("VIRL_MEM_WARNING: RMB = %b is not recommended value ; time = %t, instance = %m (sadrls0s4LOW2p128x32m1b2w0c0p0d0t0s2z0rw00_core)",RMB,$realtime);
      end
    end
  end
  if (^RMB === 1'bx) begin
