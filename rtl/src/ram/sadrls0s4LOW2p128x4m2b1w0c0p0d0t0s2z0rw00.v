...
//  Date of Generation : Fri Aug 20 18:11:32 CST 2021                  
//                                                                     
//---------------------------------------------------------------------
//   --------------------------------------------------------------     
...
module sadrls0s4LOW2p128x4m2b1w0c0p0d0t0s2z0rw00 ( QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, RMEA, RMA, ADRB, MEB, CLKB, TEST1B, RMEB, RMB);
...
reg notif_adra;
wire [3:0] notif_da;
reg notif_da_3, notif_da_2, notif_da_1, notif_da_0;
reg notif_wea;
reg notif_mea;
reg notif_clka;
...
`ifdef VIRAGE_FAST_VERILOG
`else
assign notif_da = {notif_da_3, notif_da_2, notif_da_1, notif_da_0};
...
module generic_behav_sadrls0s4LOW2p128x4m2b1w0c0p0d0t0s2z0rw00 (  QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, RMEA, RMA, ADRB, MEB, CLKB, TEST1B, RMEB, RMB );

`else

module generic_behav_sadrls0s4LOW2p128x4m2b1w0c0p0d0t0s2z0rw00 (  QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, RMEA, RMA, ADRB, MEB, CLKB, TEST1B, RMEB, RMB, CLKB_tcq,notif_adra, notif_da, notif_wea, notif_mea, notif_clka, notif_clka_CLKB_rise_rise_rec, notif_test1a, notif_rmea, notif_rma, notif_adrb, notif_meb, notif_clkb, notif_clkb_CLKA_rise_rise_rec, notif_test1b, notif_rmeb, notif_rmb );
...
parameter words = 128, bits = 4, addrbits = 7, timingmode = 1, rmbits=4;
...
genvar nk;
generate for (nk=0; nk<4; nk=nk+1)
begin : ENDA_blk
        ...
        begin
          ...
          begin
            ...
            begin
             ...
             $display("      time=%t; instance=%m (sadrls0s4LOW2p128x4m2b1w0c0p0d0t0s2z0rw00_core)",$realtime);
            end // if (RMA >= 4'b1000
          end
          else
          begin
...
begin
  ...
  begin
    ...
    begin
      if( (MES_CNTRL=="ON" || MES_CNTRL=="WARN") && $realtime != 0 && mes_all_valid == 1'b1)
      begin
       $display("VIRL_MEM_WARNING: RMB = %b is not recommended value ; time = %t, instance = %m (sadrls0s4LOW2p128x4m2b1w0c0p0d0t0s2z0rw00_core)",RMB,$realtime);
      end
    end
  end
  if (^RMB === 1'bx) begin
