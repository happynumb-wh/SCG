...
//
// Filename    : DWC_ddr_umctl2_bcm25.v
// Revision    : $Id: //dwh/ddr_iip/ictl/dev/DWC_ddr_umctl2/src/apb/DWC_ddr_umctl2_bcm25.v#22 $
// Author      : Bruce Dean 12.4.2005
// Description : DWC_ddr_umctl2_bcm25.v Verilog module for DWC_ddr_umctl2
//
// DesignWare IP ID: 4203cba9
//
////////////////////////////////////////////////////////////////////////////////
module DWC_ddr_umctl2_bcm25 (
             clk_s,
             rst_s_n,
             send_s,
             data_s,
...
`ifndef SYNTHESIS
  ...
  DWC_ddr_umctl2_sva04 #(SEND_MODE) P_DATA_SYNC_HS (.*);
